...
This project is indexed by GitNexus as **NonStopPony** (1745 symbols, 4063 relationships, 144 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/NonStopPony/context` | Codebase overview, check index freshness |
| `gitnexus://repo/NonStopPony/clusters` | All functional areas |
| `gitnexus://repo/NonStopPony/processes` | All execution flows |
| `gitnexus://repo/NonStopPony/process/{name}` | Step-by-step execution trace |
